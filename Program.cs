...
namespace SuryoyoBibliotek
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //data.AddBookIdToPersonLoanCard(2, 5); // The user with id number 2 gets the book with bookid 5
            ...
            //data.MarkBookAsNotLoaned(11); // If a book has a RentalCard connected to it, then this nulls it, clears the connection between the user and the book as not rented
        }
    }
}